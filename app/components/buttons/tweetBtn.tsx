...
const TweetBtn = () => {
  ...
  return (
    <a
      className=" text-center w-full  border-black border-4 rounded-full py-5 hover:bg-blue-400 hover:border-black hover:text-white duration-200 transition-all text-2xl font-bold shadow-xl hover:scale-95  tracking-widest"
